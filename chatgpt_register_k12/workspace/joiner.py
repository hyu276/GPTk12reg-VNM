...
Adapted from the Tampermonkey userscript:
  Mã tài khoản phụ tham gia Workspace K12 chính.txt
...
def join_workspace(
    ...
    try:
        ...
        return {"ok": False, "status_code": 0, "body": "", "workspace_id": workspace_id, "error": str(e)}
    ...
    try:
        ...
        for attempt in range(max_retries):
            try:
                post_kwargs: dict[str, Any] = {"headers": headers, "timeout": 30}
                ...
                if resp.ok:
                    return {"ok": True, "status_code": last_status, "body": last_body, "workspace_id": workspace_id}
